...
import { Cpu, BarChart3, Sparkles } from "lucide-react-native";
...
const onboardingData = [
  {
    ...
    description: "Evaluasi aktivitas harianmu dengan teknologi AI yang cerdas untuk hasil yang lebih terukur.",
    icon: <Cpu size={100} color={COLORS.primary} strokeWidth={1.5} />,
  },
  {
    id: 2,
    title: "Insight & AI\nAssistance",
    description: "Dapatkan analisis mendalam mengenai kesehatan fisik dan mentalmu langsung setiap hari.",
    icon: <BarChart3 size={100} color={COLORS.primary} strokeWidth={1.5} />,
  },
  {
    id: 3,
    title: "Ready to Start\nYour Journey?",
    description: "Siap menjadi versi terbaik dirimu? Ayo mulai perjalanan transformasimu bersama kami.",
